  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--muted)]">
      <div className="bg-[var(--background)] p-8 rounded-lg shadow-lg max-w-md w-full">
        <h1 className="text-2xl font-bold text-center mb-2">INFOCRAFT Admin</h1>
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-white border border-[var(--border)] px-4 py-3 rounded-lg hover:bg-gray-50 transition-colors"
          >
